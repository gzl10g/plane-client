...
workItemsCmd
  ...
  .option("--json", "Output as JSON")
  .action(async (opts: { project?: string; name: string; priority?: string; state?: string; descriptionHtml?: string; labels?: string; assignees?: string; json?: boolean }) => {
    await runHandler(async () => {
