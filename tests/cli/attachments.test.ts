...
describe("attachments CLI handlers", () => {
  ...
  it("handleAttachmentsDelete calls delete and confirms", async () => {
    ...
    try {
      ...
      // Borrar un adjunto ahora pide confirmación, como el resto de destructivos.
      await handleAttachmentsDelete(WORK_ITEM, "a1", { project: PROJECT, yes: true }, { client: mockClient });
